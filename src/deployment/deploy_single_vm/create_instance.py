...
def create_instance():
    ...
    project = gcp_config.require("project")  # noqa: F841
    ...
    location = os.environ["GCP_REGION"]  # noqa: F841
    zone = os.environ["GCP_ZONE"]

    # Configuration variables
    persistent_disk_name = "tummyai-app-demo-disk"
    persistent_disk_size = 50
    machine_instance_name = "tummyai-app-demo"
